...
func TestClosedDB_MiniMaxStoreFunctions(t *testing.T) {
	...
	t.Run("InsertMiniMaxSnapshot", func(t *testing.T) {
		_, err := s.InsertMiniMaxSnapshot(newTestMiniMaxSnapshot(now, 100, 20))
		if err == nil {
	...
	t.Run("QueryMiniMaxRange", func(t *testing.T) {
		_, err := s.QueryMiniMaxRange(now.Add(-time.Hour), now.Add(time.Hour))
		if err == nil {
	...
	t.Run("CreateMiniMaxCycle", func(t *testing.T) {
		_, err := s.CreateMiniMaxCycle("MiniMax-M2", now, nil)
		if err == nil {
	...
	t.Run("CloseMiniMaxCycle", func(t *testing.T) {
		err := s.CloseMiniMaxCycle("MiniMax-M2", now, 10, 5)
		if err == nil {
	...
	t.Run("UpdateMiniMaxCycle", func(t *testing.T) {
		err := s.UpdateMiniMaxCycle("MiniMax-M2", 10, 5)
		if err == nil {
	...
	t.Run("QueryActiveMiniMaxCycle", func(t *testing.T) {
		_, err := s.QueryActiveMiniMaxCycle("MiniMax-M2")
		if err == nil {
	...
	t.Run("QueryMiniMaxCycleHistory", func(t *testing.T) {
		_, err := s.QueryMiniMaxCycleHistory("MiniMax-M2")
		if err == nil {
	...
	t.Run("QueryMiniMaxUsageSeries", func(t *testing.T) {
		_, err := s.QueryMiniMaxUsageSeries("MiniMax-M2", now.Add(-time.Hour))
		if err == nil {
	...
	t.Run("QueryAllMiniMaxModelNames", func(t *testing.T) {
		_, err := s.QueryAllMiniMaxModelNames()
		if err == nil {
	...
	t.Run("queryMiniMaxSnapshotAtOrBefore", func(t *testing.T) {
		_, err := s.queryMiniMaxSnapshotAtOrBefore(now)
		if err == nil {
	...
	t.Run("minimaxCrossQuotasAt", func(t *testing.T) {
		_, err := s.minimaxCrossQuotasAt(now)
		if err == nil {
	...
	t.Run("QueryMiniMaxCycleOverview", func(t *testing.T) {
		_, err := s.QueryMiniMaxCycleOverview("MiniMax-M2", 10)
		if err == nil {
	...
	t.Run("QueryMiniMaxCycleOverview default-group query error", func(t *testing.T) {
		_, err := s.QueryMiniMaxCycleOverview("", 10)
		if err == nil {
